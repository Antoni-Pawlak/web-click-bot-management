                            ...
                            {paginatedData && 
                                <tbody>  
                                    {paginatedData.map((keyword, index)=>(
                                        <TableRow key={index} bgColor={index%2===0 ? "bg-transparent": "bg-slate-50"} id={keyword?.id} keyword={keyword.keyword} img={keyword?.img} link={keyword.link} amount={keyword.amount} last_login={keyword.last_login} 
